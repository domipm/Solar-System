...
data = np.loadtxt("outg.txt")  # Geocentric coordinates
...
skip = 20       # Number of iterations to skip in each frame
...
def init():
    ...
    ax.set_title("Solar System (Geocentric)")
    ax.set_xlabel("x [AU]")
    ax.set_ylabel("y [AU]")
...
anim.save("animated_orbits_geo.gif", writer='imagemagick', fps=60, dpi=300)
